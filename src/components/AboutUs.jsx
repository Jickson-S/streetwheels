export default function AboutUs() {
  return (
    <section className="py-20 px-4 bg-white text-gray-800">
      <h2 className="text-3xl font-bold text-center mb-6">Why Choose Street Wheels?</h2>
      <div className="max-w-4xl mx-auto text-lg leading-relaxed space-y-4">
        <p>
          Street Wheels Cars Private Limited is your go-to platform for convenient, affordable, and reliable car rental solutions. Whether you’re exploring the city, heading on a weekend getaway, or need a driver at short notice, our extensive fleet and experienced staff are here to support you 24/7.
        </p>
        <p>
